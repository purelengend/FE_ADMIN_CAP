...
import WishlistItem from './CartItem/CartItem'
...
export default function ViewCart() {
  ...
  const cart = useQuery({
    queryKey: ['cart', uuid],
    queryFn: () => getCartByUserId(uuid as string, accessToken),
    staleTime: 0,
    ...
    <div className='single'>
      ...
      <div className='single-container'>
        ...
        <div className='bottom'>
          <h1 className='title'>
            Cart Item List of User-{cart.data?.data.userId}
          </h1>
          <CartItem rows={cart.data?.data.itemList ?? []} />
        </div>
      </div>
    </div>
  )
