...
export default function ViewWishlist() {
  ...
  const wishlist = useQuery({
    queryKey: ['wishlist', uuid],
    queryFn: () => getWishlistByUserId(uuid as string, accessToken),
    staleTime: 0,
    ...
    <div className='single'>
      ...
      <div className='single-container'>
        ...
        <div className='bottom'>
          <h1 className='title'>Wishlist Item List</h1>
          <WishlistItem rows={wishlist.data?.data.itemList ?? []} />
        </div>
      </div>
    </div>
  )
